  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      <div className="flex items-center justify-center min-h-screen p-4 sm:p-0">
        ...
        {/* Panel */}
        <div className="relative bg-white dark:bg-slate-800 rounded-lg shadow-xl max-w-4xl w-full mx-auto max-h-[90vh] overflow-hidden flex flex-col">
          {/* Header */}
          ...
          <div className="overflow-y-auto flex-1 p-6">
            ...
            {!loading && items.length === 0 && (
              <div className="text-center py-12">
                ...
                <h3 className="mt-2 text-sm font-medium text-slate-900 dark:text-white">All caught up!</h3>
            ...
            {!loading && items.length > 0 && (
              <div className="space-y-4">
                {items.map((item) => (
                  <div
                    key={item.id}
                    className="bg-slate-50 dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-700 p-4 sm:p-6"
                  >
                    {/* Item Header */}
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-2 mb-3">
                          <span className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300">
                    ...
                    <div className="space-y-3 mb-4">
                      ...
                      {item.meeting_title && (
                        <div className="flex items-center text-sm">
                          ...
                          <span className="text-slate-600 dark:text-slate-400">
                            From: <strong>{item.meeting_title}</strong>
                            {item.meeting_date && (
                              <span className="ml-1">
